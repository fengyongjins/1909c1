		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
						<div id="exs" style="width:600px;height:400px">
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<td>学生爱好：</td>
								...
								<input type="checkbox" name="sdhobby" value="吃鸡">吃鸡
								<input type="checkbox" name="sdhobby" value="王者农药">王者农药
								<input type="checkbox" name="sdhobby" value="消消乐">消消乐
								</td>
							</tr>
							<tr>
							<td>学生生日：</td>
								<td>
						      <input type="date" id="bit" name="sdbirth">
								</td>
...
Date.prototype.Format = function (fmt) {
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    		    		...
	    		    		for (var i = 0; i <slist.length; i++) {
	    		    			...
	    		    			xdata[i]=slist[i].mdname
	    		    			
	    		    			ydata[i]=slist[i].num
							}
	    		    	
	    		    		$(function(){
	    		    			var myChart= echarts.init(document.getElementById('exs'));
	    		    			var option={
	    		    					title:{
	    		    						text:'学生统计'
	    		    					},
	...
	function initEditUser(getSelection){
		...
		$('#bit').val(new Date(getSelection.sdbirth).Format('yyyy-MM-dd'));
		$('#sex').val(getSelection.sdsex);
