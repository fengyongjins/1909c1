				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
							<td>生日：</td>
								<td><input ty type="date" name="birthday" id="bid"></td>
							</tr>
							
							<tr>
								<td valign="middle">爱好：</td>
								<td>
								<input ty type="checkbox" name="hobbys" value="LOL">LOL
								<input ty type="checkbox" name="hobbys" value="梦幻西游">梦幻西游
								<input ty type="checkbox" name="hobbys" value="问道">问道
								<input ty type="checkbox" name="hobbys" value="DNF">DNF
								<input ty type="checkbox" name="hobbys" value="剑灵">剑灵
								<input ty type="checkbox" name="hobbys" value="飞车">飞车
								</td>
							</tr>
							<tr>
							<td>照片：</td>
								<td><input ty type="file" name="pic"></td>
							</tr>
						</table>
